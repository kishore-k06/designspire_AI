import type { AnimationClip, Audio, Camera, Object3D, Quaternion, SkinnedMesh, Bone, AnimationMixer } from 'three'

import type { CCDIKSolver } from './CCDIKSolver.d.cts'
import type { MMDPhysics } from './MMDPhysics.d.cts'
